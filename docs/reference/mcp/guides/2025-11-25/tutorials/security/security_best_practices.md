...
[MCP Authorization](../../../../specification/2025-11-25/basic/authorization.md)
...
6. The MCP authorization code is redirected to the attacker's server
   ...
   [dynamic client registration](../../../../specification/2025-11-25/basic/authorization.md#dynamic-client-registration))
...
2. The attacker obtains an existing session ID and sends a malicious
   ...
   * When a server supports
     [redelivery/resumable streams](../../../../specification/2025-11-25/basic/transports.md#resumability-and-redelivery),
