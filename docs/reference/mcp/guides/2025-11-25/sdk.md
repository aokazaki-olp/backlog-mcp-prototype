...
section: guides
version: 2025-11-25
source: "https://modelcontextprotocol.io/docs/2025-11-25/sdk"
fetched: 2026-09-06
---
...
See [SDK Tiering System](https://modelcontextprotocol.io/community/sdk-tiers) for details on what each tier means.
...
<CardGroup cols={2}>
  <Card title="Build a Server" icon="server" href="develop/build-server.md">
    Learn how to create your first MCP server
  </Card>

  <Card title="Build a Client" icon="computer" href="develop/build-client.md">
