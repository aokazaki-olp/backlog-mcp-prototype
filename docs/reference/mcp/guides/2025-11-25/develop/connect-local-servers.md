...
section: guides
version: 2025-11-25
source: "https://modelcontextprotocol.io/docs/2025-11-25/develop/connect-local-servers"
fetched: 2026-09-06
---
...
<CardGroup cols={2}>
  ...
  <Card title="Build your own server" icon="code" href="build-server.md">
    Create custom MCP servers tailored to your specific workflows and
    integrations
  </Card>

  <Card title="Connect to remote servers" icon="cloud" href="connect-remote-servers.md">
    Learn how to connect Claude to remote MCP servers for cloud-based tools and
    services
  </Card>

  <Card title="Understand the protocol" icon="book" href="../learn/architecture.md">
