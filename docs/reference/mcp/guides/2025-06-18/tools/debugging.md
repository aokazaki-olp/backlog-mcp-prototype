...
section: guides
version: 2025-06-18
source: "https://modelcontextprotocol.io/docs/2025-06-18/tools/debugging"
fetched: 2026-09-06
---
...
1. **[MCP Inspector](inspector.md)**: interactive, transport-agnostic
   testing UI. Connect to stdio or Streamable HTTP servers, invoke
   [tools](../../../specification/2025-06-18/server/tools.md),
   [prompts](../../../specification/2025-06-18/server/prompts.md), and
   [resources](../../../specification/2025-06-18/server/resources.md), and watch the
   notification stream. This should be your first stop.
2. **Server logging**: structured logs to stderr (stdio transport) or via
   [`notifications/message`](../../../specification/2025-06-18/server/utilities/logging.md#log-message-notifications)
   (all transports).
...
[stdio transport](../../../specification/2025-06-18/basic/transports.md#stdio), all messages
...
[Streamable HTTP transport](../../../specification/2025-06-18/basic/transports.md#streamable-http),
...
[`Mcp-Session-Id` headers](../../../specification/2025-06-18/basic/transports.md#session-management),
and SSE streams.

For all [transports](../../../specification/2025-06-18/basic/transports.md), you can also
...
MCP defines eight
[RFC 5424 severity levels](../../../specification/2025-06-18/server/utilities/logging.md#log-levels)
(`debug` through `emergency`). Clients can adjust the minimum level at runtime
via the
[`logging/setLevel`](../../../specification/2025-06-18/server/utilities/logging.md#setting-log-level)
request.
...
[`claude_desktop_config.json`](../develop/connect-local-servers.md); the same
...
3. Test standalone with [Inspector](inspector.md)
4. Verify
   [protocol compatibility](../../../specification/2025-06-18/basic/lifecycle.md#version-negotiation)
5. Check
   [capability negotiation](../../../specification/2025-06-18/basic/lifecycle.md#capability-negotiation):
   error [`-32602`](../../../specification/2025-06-18/basic/lifecycle.md#error-handling) is
   the standard JSON-RPC "Invalid params" code and is returned in many
   contexts. One common cause is a server sending
   [sampling](../../../specification/2025-06-18/client/sampling.md) or
   [elicitation](../../../specification/2025-06-18/client/elicitation.md) requests to a
   client that hasn't declared that capability. Inspect the
   [`initialize` exchange](../../../specification/2025-06-18/basic/lifecycle.md#initialization)
...
1. Initial Development
   * Use [Inspector](inspector.md) for basic testing
...
* **Quick iteration**: Use [Inspector](inspector.md) during
  development
...
[Security Best Practices](../tutorials/security/security_best_practices.md).
...
1. **First Steps**
   * Check server logs
   * Test with [Inspector](inspector.md)
...
<CardGroup cols={2}>
  <Card title="MCP Inspector" icon="magnifying-glass" href="inspector.md">
    Learn to use the MCP Inspector
  </Card>

  <Card title="Build an MCP server" icon="code" href="../develop/build-server.md">
    Walk through building a server from scratch
  </Card>

  <Card title="Connect local servers" icon="plug" href="../develop/connect-local-servers.md">
