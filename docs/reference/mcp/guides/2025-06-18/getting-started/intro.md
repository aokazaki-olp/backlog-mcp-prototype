...
section: guides
version: 2025-06-18
source: "https://modelcontextprotocol.io/docs/2025-06-18/getting-started/intro"
fetched: 2026-09-06
---
...
<CardGroup cols={2}>
  <Card title="Build servers" icon="server" href="../develop/build-server.md">
    Create MCP servers to expose your data and tools
  </Card>

  <Card title="Build clients" icon="computer" href="../develop/build-client.md">
    Develop applications that connect to MCP servers
  </Card>

  <Card title="Build MCP Apps" icon="puzzle-piece" href="../../../extensions/apps/overview.md">
...
<CardGroup cols={2}>
  <Card title="Understand concepts" icon="book" href="../learn/architecture.md">
