...
section: guides
version: 2025-06-18
source: "https://modelcontextprotocol.io/docs/2025-06-18/develop/build-with-agent-skills"
fetched: 2026-09-06
---
...
* **User interaction needs** — plain text results, structured input via
  [elicitation](../../../specification/2025-06-18/client/elicitation.md), or rich UI widgets
...
**Remote [Streamable HTTP](../../../specification/2025-06-18/basic/transports.md#streamable-http)**
...
**[MCP apps](../../../extensions/apps/overview.md)** extend a server with interactive
widgets rendered in chat, such as searchable pickers, charts, and live
dashboards. The skill hands off to `build-mcp-app` when
[elicitation's](../../../specification/2025-06-18/client/elicitation.md) flat-form constraints
don't fit.
...
**Local [stdio](../../../specification/2025-06-18/basic/transports.md#stdio)** remains available
...
<CardGroup cols={2}>
  <Card title="MCP Inspector" icon="magnifying-glass" href="../tools/inspector.md">
    Test your server's tools, resources, and prompts interactively
  </Card>

  <Card title="Connect to a client" icon="plug" href="connect-local-servers.md">
    Wire your server into an MCP client via local or remote configuration
  </Card>

  <Card title="Publish to the Registry" icon="box" href="https://modelcontextprotocol.io/registry/quickstart">
