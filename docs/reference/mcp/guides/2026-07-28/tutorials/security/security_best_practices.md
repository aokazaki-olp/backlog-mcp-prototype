...
[MCP Authorization](../../../../specification/2026-07-28/basic/authorization.md)
...
6. The MCP authorization code is redirected to the attacker's server
   ...
   [dynamic client registration](../../../../specification/2026-07-28/basic/authorization.md#dynamic-client-registration))
...
[authorization specification](../../../../specification/2026-07-28/basic/authorization.md)
...
server supports
[Client ID Metadata Documents](../../../../specification/2026-07-28/basic/authorization/client-registration.md#client-id-metadata-documents),
...
MCP is [stateless](../../../../specification/2026-07-28/basic.md#statelessness) and
...
[Session Hijacking in the 2025-11-25 version of this page](../../../2025-11-25/tutorials/security/security_best_practices.md#session-hijacking).
...
[Authorization Response Validation](../../../../specification/2026-07-28/basic/authorization.md#authorization-response-validation)
...
See
[Localhost Redirect URI Risks](../../../../specification/2026-07-28/basic/authorization/security-considerations.md#localhost-redirect-uri-risks)
...
[Trust Policies](../../../../specification/2026-07-28/basic/authorization/security-considerations.md#trust-policies)
...
parameter, the
[Scope Selection Strategy](../../../../specification/2026-07-28/basic/authorization.md#scope-selection-strategy)
...
<Note>
  ...
  **SHOULD** compute the union of previously requested scopes and newly
  ...
  Authorization
  Flow](../../../../specification/2026-07-28/basic/authorization.md#step-up-authorization-flow).
