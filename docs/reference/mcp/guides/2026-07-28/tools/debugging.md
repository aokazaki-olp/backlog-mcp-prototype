...
1. **[MCP Inspector](inspector.md)**: interactive, transport-agnostic
   ...
   [tools](../../../specification/2026-07-28/server/tools.md),
   [prompts](../../../specification/2026-07-28/server/prompts.md), and
   [resources](../../../specification/2026-07-28/server/resources.md), and watch the
...
2. **Server logging**: structured logs to stderr (stdio transport) or via
   ...
   [Logging](../../../specification/2026-07-28/server/utilities/logging.md) over the protocol
...
[stdio transport](../../../specification/2026-07-28/basic/transports/stdio.md), all messages
...
[Streamable HTTP transport](../../../specification/2026-07-28/basic/transports/streamable-http.md),
...
For all [transports](../../../specification/2026-07-28/basic/transports.md), record what the
...
MCP defines eight
[RFC 5424 severity levels](../../../specification/2026-07-28/server/utilities/logging.md#log-levels)
(`debug` through `emergency`). Clients opt in to log messages per request by
setting the
[`io.modelcontextprotocol/logLevel`](../../../specification/2026-07-28/server/utilities/logging.md#per-request-log-level)
...
4. Verify
   [protocol compatibility](../learn/versioning.md#negotiation): call
   [`server/discover`](../../../specification/2026-07-28/server/discover.md) to see which
...
5. Check the
   [per-request `_meta` fields](../../../specification/2026-07-28/basic.md#meta):
   ...
   [elicitation](../../../specification/2026-07-28/client/elicitation.md), it returns a
   `MissingRequiredClientCapabilityError` (`-32021`) naming the missing
   capabilities. Inspect the request's `_meta` and the
   [`server/discover`](../../../specification/2026-07-28/server/discover.md) response to
