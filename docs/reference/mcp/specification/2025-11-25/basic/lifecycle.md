...
<Note>
  ...
  server.
  For details, see [the Protocol Version Header section in Transports](transports.md#protocol-version-header).
</Note>
...
| Client   | `elicitation`  | Support for server [elicitation](../client/elicitation.md) requests       |
| Client   | `tasks`        | Support for [task-augmented](utilities/tasks.md) client requests |
...
| Server   | `tasks`        | Support for [task-augmented](utilities/tasks.md) server requests |
