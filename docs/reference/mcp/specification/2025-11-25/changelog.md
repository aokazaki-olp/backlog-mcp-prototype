...
the previous revision, [2025-06-18](../2025-06-18/index.md).
...
6. Added support for [URL mode elicitation](client/elicitation.md#url-elicitation-requests) ([SEP-1036](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/887))
...
9. Add experimental support for [tasks](basic/utilities/tasks.md) to enable tracking durable requests with polling and deferred result retrieval ([SEP-1686](https://github.com/modelcontextprotocol/modelcontextprotocol/issues/1686)).
...
4. Updated the [Security Best Practices guidance](https://modelcontextprotocol.io/docs/draft/tutorials/security/security_best_practices).
