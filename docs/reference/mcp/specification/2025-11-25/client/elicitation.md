...
[initialization](../basic/lifecycle.md#initialization):
...
Servers implementing elicitation **MUST** securely associate this state with individual users following the guidelines in the [security best practices](../../../guides/2025-11-25/tutorials/security/security_best_practices.md) document. Specifically:
...
2. **The MCP server MUST NOT use the client's credentials for the third-party service**: That would be [token passthrough](../../../guides/2025-11-25/tutorials/security/security_best_practices.md#token-passthrough), which is forbidden
...
<Note>
  ...
  section](../../../guides/2025-11-25/tutorials/security/security_best_practices.md#token-passthrough) of the Security
...
Instead, servers **SHOULD** follow [security best practices](../../../guides/2025-11-25/tutorials/security/security_best_practices.md).
