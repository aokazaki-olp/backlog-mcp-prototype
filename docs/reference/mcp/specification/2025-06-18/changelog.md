...
2. Add support for [structured tool output](server/tools.md#structured-content)
   (PR [#371](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/371))
3. Classify MCP servers as [OAuth Resource Servers](basic/authorization.md#authorization-server-discovery),
...
5. Clarify [security considerations](basic/authorization.md#security-considerations) and best practices
   in the authorization spec and in a new [security best practices page](../../guides/2025-11-25/tutorials/security/security_best_practices.md).
6. Add support for **[elicitation](client/elicitation.md)**, enabling servers to request additional
   information from users during interactions.
   (PR [#382](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/382))
7. Add support for **[resource links](server/tools.md#resource-links)** in
   tool call results. (PR [#603](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/603))
8. Require [negotiated protocol version to be specified](basic/transports.md#protocol-version-header)
...
1. Add `_meta` field to additional interface types (PR [#710](https://github.com/modelcontextprotocol/modelcontextprotocol/pull/710)),
   and specify [proper usage](basic.md#meta).
