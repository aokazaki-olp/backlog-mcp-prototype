...
supports [caching](utilities/caching.md).
...
This operation supports [pagination](utilities/pagination.md) and [caching](utilities/caching.md).
...
[subscriptions-listen]: ../schema.md#subscriptionslistenrequest

[subscriptions]: ../basic/patterns/subscriptions.md
