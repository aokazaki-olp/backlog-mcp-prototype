...
[multi round-trip requests](../../basic/patterns/mrtr.md)) are not cacheable
...
[multi round-trip requests](../../basic/patterns/mrtr.md) mechanism—that
...
When a list result is [paginated](pagination.md), each
