...
version: 2026-07-28
source: "https://modelcontextprotocol.io/specification/2026-07-28/architecture"
fetched: 2026-09-06
---
...
[`server/discover`](server/discover.md), which clients may call before
...
* Implemented [server features](server.md) must be advertised in the
  server's capabilities
* Receiving resource update notifications requires opening a
  [`subscriptions/listen`](basic/patterns/subscriptions.md) stream
  with the desired resource URIs
* [Tool](server/tools.md) invocation requires the server to declare tool capabilities
