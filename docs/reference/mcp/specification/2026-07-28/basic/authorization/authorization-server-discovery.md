...
another. See
[Authorization Server Binding](client-registration.md#authorization-server-binding)
...
are defined in the [Scope Selection Strategy](../authorization.md#scope-selection-strategy) section.
