...
[notifications-progress]: ../patterns/progress.md

[notifications-message]: ../../server/utilities/logging.md

[input-required-result]: ../../schema.md#inputrequiredresult

[mrtr]: ../patterns/mrtr.md

[sep-2322]: https://modelcontextprotocol.io/seps/2322-MRTR

[subscriptions-listen]: ../patterns/subscriptions.md
...
[cancellation]: ../patterns/cancellation.md
...
[unsupported-version]: ../../schema.md#unsupportedprotocolversionerror

[lifecycle-version]: ../versioning.md#protocol-version-negotiation
...
[tool-definitions]: ../../server/tools.md#x-mcp-header
...
| -------- | ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| `-32020` | [`HeaderMismatch`](../../schema.md#headermismatcherror) | The HTTP headers do not match the corresponding values in the request body, or required headers are missing/malformed. |

This error code is allocated from the sub-range the MCP specification
reserves for protocol-defined errors. See
[Error Codes](../../basic.md#error-codes).
...
Protocol versions `2025-03-26` through [`2025-11-25`](../../../2025-11-25/basic/transports.md)
...
[2025-11-25: Streamable HTTP](../../../2025-11-25/basic/transports.md#streamable-http)),
...
[lifecycle-compat]: ../versioning.md#backward-compatibility-with-initialization-based-versions
