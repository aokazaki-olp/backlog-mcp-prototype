...
resource server or a separate entity. [Authorization Server Discovery](authorization/authorization-server-discovery.md)
...
2. Authorization servers and MCP clients **SHOULD** support [OAuth Client ID Metadata Documents](authorization/client-registration.md#client-id-metadata-documents)
...
3. Authorization servers and MCP clients **MAY** support the OAuth 2.0 Dynamic Client Registration
   ...
   [Dynamic Client Registration](authorization/client-registration.md#dynamic-client-registration)
...
4. MCP servers **MUST** implement OAuth 2.0 Protected Resource Metadata ([RFC9728](https://datatracker.ietf.org/doc/html/rfc9728)).
   MCP clients **MUST** use OAuth 2.0 Protected Resource Metadata for [authorization server discovery](authorization/authorization-server-discovery.md).
...
5. MCP authorization servers **MUST** provide at least one of the following discovery mechanisms:
   ...
   * [OpenID Connect Discovery 1.0](https://openid.net/specs/openid-connect-discovery-1_0.html)
   ...
   MCP clients **MUST** support both [discovery mechanisms](authorization/authorization-server-discovery.md#authorization-server-metadata-discovery) to obtain the information required to interact with the authorization server.
...
[Authorization Server Discovery](authorization/authorization-server-discovery.md).
...
[Client Registration](authorization/client-registration.md).
...
for basic functionality (see [Scope Minimization](../../../guides/2026-07-28/tutorials/security/security_best_practices.md#scope-minimization)),
...
requirements in [Security Considerations](authorization/security-considerations.md),
