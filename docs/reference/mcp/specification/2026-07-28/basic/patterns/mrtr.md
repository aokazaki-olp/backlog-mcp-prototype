...
An [`InputRequests`](../../schema.md#inputrequests) object is a map of server-client requests.
Keys are server-assigned string identifiers;
values are request objects (e.g., [`ElicitRequest`](../../schema.md#elicitrequest), [`CreateMessageRequest`](../../schema.md#createmessagerequest), or [`ListRootsRequest`](../../schema.md#listrootsrequest)).
...
An [`InputResponses`](../../schema.md#inputresponses) object is a map of client responses to the server requests.
Keys correspond to the keys in the `InputRequests` map; values are the client's result for each request (e.g., [`ElicitResult`](../../schema.md#elicitresult), [`CreateMessageResult`](../../schema.md#createmessageresult), or [`ListRootsResult`](../../schema.md#listrootsresult)).
...
An [`InputRequiredResult`](../../schema.md#inputrequiredresult) is a type of [`Result`](../../basic.md#responses),
indicating that additional input is needed before the request can be completed.

* `inputRequests` *(optional)*: An [`InputRequests`](../../schema.md#inputrequests) map of server-initiated requests that the client must fulfill.
...
| -------------------------------------------------------------------------------- | ---------------------------- |
| [`prompts/get`](../../server/prompts.md#getting-a-prompt)       | Yes                          |
| [`resources/read`](../../server/resources.md#reading-resources) | Yes                          |
| [`tools/call`](../../server/tools.md#calling-tools)             | Yes                          |
...
2. The `InputRequiredResult` **MAY** include an `inputRequests` field.
   ...
   * `inputRequests` values are request objects that **MUST** be one of [`ElicitRequest`](../../schema.md#elicitrequest), [`CreateMessageRequest`](../../schema.md#createmessagerequest), or [`ListRootsRequest`](../../schema.md#listrootsrequest)
