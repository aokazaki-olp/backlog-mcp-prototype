...
version: 2026-07-28
source: "https://modelcontextprotocol.io/specification/2026-07-28/basic/patterns"
fetched: 2026-09-06
---
...
[requests, responses, and notifications](../basic.md#messages)
into interactions. Every
[transport](transports.md) carries all of these
...
and [`notifications/message`](../server/utilities/logging.md).
...
[`InputRequiredResult`](patterns/mrtr.md#inputrequiredresult)
and the client retries the request with the matching `inputResponses`. See
[Multi Round-Trip Requests](patterns/mrtr.md).
