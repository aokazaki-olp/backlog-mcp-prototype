...
Beyond the core protocol, MCP defines optional [extensions](../../extensions/overview.md)
...
* **[Tasks](../../extensions/tasks/overview.md)**: Asynchronous execution of long-running
...
* **[MCP Apps](../../extensions/apps/overview.md)**: Interactive UI elements (charts, forms,
...
<CardGroup cols={5}>
  <Card title="Architecture" icon="sitemap" href="architecture.md" />

  <Card title="Base Protocol" icon="code" href="basic.md" />

  <Card title="Server Features" icon="server" href="server.md" />

  <Card title="Client Features" icon="user" href="client/roots.md" />

  <Card title="Contributing" icon="pencil" href="https://modelcontextprotocol.io/community/contributing" />
</CardGroup>
