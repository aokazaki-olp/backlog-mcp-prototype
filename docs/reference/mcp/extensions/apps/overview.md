...
<Note>
  MCP Apps is an extension to the [core MCP specification](../../specification/2026-07-28/index.md). Host support varies by client.
</Note>
...
[client matrix](../client-matrix.md) for the full list of extension support across clients.
...
To start building your own MCP App, see the [build guide](build.md).
