...
Check the [client matrix](../client-matrix.md) for current implementation status across MCP clients. Enterprise-Managed Authorization typically requires client-level support from the organization's IT team in addition to the MCP client application.
...
<CardGroup cols={2}>
  ...
  <Card title="SEP-990" icon="file-lines" href="https://modelcontextprotocol.io/seps/990-enable-enterprise-idp-policy-controls-during-mcp-o">
    Original proposal: Enable Enterprise IdP Policy Controls
  </Card>

  <Card title="MCP Authorization" icon="lock" href="../../specification/2026-07-28/basic/authorization.md">
