---
title: Wikiの共有ファイルのリンクを解除
slug: remove-link-to-shared-file-from-wiki
method: DELETE
path: "/api/v2/wikis/:wikiId/sharedFiles/:id"
category: wikis
source: "https://developer.nulab.com/ja/docs/backlog/api/2/remove-link-to-shared-file-from-wiki/"
fetched: 2026-08-30
---
