---
title: プロジェクトの最近の活動の取得
slug: get-project-recent-updates
method: GET
path: "/api/v2/projects/:projectIdOrKey/activities"
category: projects
source: "https://developer.nulab.com/ja/docs/backlog/api/2/get-project-recent-updates/"
fetched: 2026-08-30
---
...
| パラメーター名 | 型 | 内容 |
| --- | --- | --- |
| activityTypeId[]<br>[(複数指定可)](../guides/tips.md) | int | type(1-49) |
| minId | int | 最小ID |
| maxId | int | 最大ID |
