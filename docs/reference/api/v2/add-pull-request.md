---
title: プルリクエストの追加
slug: add-pull-request
method: POST
path: "/api/v2/projects/:projectIdOrKey/git/repositories/:repoIdOrName/pullRequests"
category: git
source: "https://developer.nulab.com/ja/docs/backlog/api/2/add-pull-request/"
fetched: 2026-08-30
---
...
| パラメーター名 | 型 | 内容 |
| --- | --- | --- |
| summary (必須) | string | プルリクエストの件名 |
| description (必須) | string | プルリクエストの詳細。[メンション記法](../guides/tips.md#mention-users-in-text)が使えます。 |
| base (必須) | string | マージ先のブランチ名 |
| branch (必須) | string | マージされるブランチ名 |
| issueId | int | 関連課題のID |
