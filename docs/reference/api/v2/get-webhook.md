...
category: projects
source: "https://developer.nulab.com/ja/docs/backlog/api/2/get-webhook/"
fetched: 2026-08-30
---
...
プロジェクトに登録されているWebhookの情報を取得します。  
Webhookは、[Webhook一覧の取得](./get-list-of-webhooks.md)から取得できます。
