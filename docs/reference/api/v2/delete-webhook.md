...
category: projects
source: "https://developer.nulab.com/ja/docs/backlog/api/2/delete-webhook/"
fetched: 2026-08-30
---
...
プロジェクトに登録されているWebhookを削除します。  
削除したいWebhookは[Webhook一覧の取得](./get-list-of-webhooks.md)から取得できます。
