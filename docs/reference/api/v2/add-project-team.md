---
title: プロジェクトチームの追加
slug: add-project-team
method: POST
path: "/api/v2/projects/:projectIdOrKey/teams"
category: projects
source: "https://developer.nulab.com/ja/docs/backlog/api/2/add-project-team/"
fetched: 2026-08-30
---
...
```http
POST /api/v2/projects/:projectIdOrKey/teams
```
