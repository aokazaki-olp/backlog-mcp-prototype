---
title: Wikiページの削除
slug: delete-wiki-page
method: DELETE
path: "/api/v2/wikis/:wikiId"
category: wikis
source: "https://developer.nulab.com/ja/docs/backlog/api/2/delete-wiki-page/"
fetched: 2026-08-30
---
...
| パラメーター名 | 型 | 内容 |
| --- | --- | --- |
| mailNotify | boolean | ページの削除をメールで通知する場合はtrue |
